...
! ---------------- INTERFACE إنترنت (اختياري) ----------------

! إذا تبغى تمثل إنترنت خارجي (مثلاً شبكة وهمية)
...
! رجوع الترافيك إلى شبكاتك

ip route 192.168.0.0 255.255.0.0 200.1.1.2

ip route 192.169.0.0 255.255.0.0 200.1.1.2
